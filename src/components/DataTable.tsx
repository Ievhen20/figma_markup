        ...
        <div className="card card-grid min-w-full">
          ...
          <div id="kt_remote_group_check_table" >
            ...
            <table className="table table-auto table-border overflow-auto text-nowrap" data-datatable-table="true">
              ...
              <tbody>
                { (datas as any).data?.length > 0 &&
                  (datas as any).data.map((row:any, index:number) => (
                  <tr key={index} className="text-center">
                    ...
                    <td>{row.item2}</td>
                    <td>{row.item3}</td>
                    {/* Optionally render status1 if it exists */}
                    {row.item4 && <td >{row.item4}</td>}
                    {row.item5 && <td >{row.item5}</td>}
                    {row.item6 && <td >{row.item6}</td>}
                    {row.item7 && <td >{row.item7}</td>}
                    {row.item8 && <td >{row.item8}</td>}
                    {row.item9 && <td >{row.item9}</td>}
                    {row.item10 && <td >{row.item10}</td>}
                    {row.item11 && <td >{row.item11}</td>}
                    {row.item12 && <td >{row.item12}</td>}
                    {row.item13 && <td >{row.item13}</td>}
                  </tr>
                ))}
              </tbody>
            </table>
